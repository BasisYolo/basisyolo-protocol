...
contract BYSHUSDLPTokenSharePool is
    LPTokenWrapper,
    IRewardDistributionRecipient
{
    ...
    modifier checkStart() {
        require(
            ...
            'BagsHusdLPTokenSharePool: not start'
        );
        _;
    }
    ...
    function stake(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'BagsHusdLPTokenSharePool: Cannot stake 0');
        super.stake(amount);
    ...
    function withdraw(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'BagsHusdLPTokenSharePool: Cannot withdraw 0');
